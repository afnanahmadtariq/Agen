...
class DownloadScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: Colors.grey[400], // Background color similar to the image
      body: Center(
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              Image.asset(
                'assets/pdf_icon.png', // Placeholder for your custom image
                width: 80.0,
                height: 80.0,
              ),
              ...
              const SizedBox(height: 10.0),
              const Text(
                'Click the below button to start the Download or View Assignment',
                style: TextStyle(
                  fontSize: 14.0,
                  color: Colors.black54,
                ),
